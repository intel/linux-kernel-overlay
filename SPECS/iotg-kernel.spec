...
%define rpmversion  5.10.162
%if %{?isrc}
%define rcversion   rt79.
%endif
%define embargoname 0201.lts2020_rt
...
%define specrelease %{?rcversion}230201T182033Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.10.162-rt79
