...
%define rpmversion  6.15.0
%if %{?isrc}
%define rcversion   rc3.
%endif
%define embargoname 0522.mainline_tracking
...
%define specrelease %{?rcversion}250522T071016Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v6.15-rc3
