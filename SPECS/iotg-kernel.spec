...
%define rpmversion  5.15.113
%if %{?isrc}
%define rcversion   rt64.
%endif
%define embargoname 0530.lts2021_rt
...
%define specrelease %{?rcversion}230530T192215Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.15.113-rt64
