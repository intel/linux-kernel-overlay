...
%define rpmversion  5.15.119
%if %{?isrc}
%define rcversion   rt65.
%endif
%define embargoname 0710.lts2021_rt
...
%define specrelease %{?rcversion}230710T040825Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.15.119-rt65
