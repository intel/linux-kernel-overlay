...
%define rpmversion  5.10.131
%if %{?isrc}
%define rcversion   rt72.
%endif
%define embargoname 0815.lts2020_rt
...
%define specrelease %{?rcversion}220815T115424Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.10.131-rt72
