...
%define rpmversion  5.10.158
%if %{?isrc}
%define rcversion   rt77.
%endif
%define embargoname 1230.lts2020_rt
...
%define specrelease %{?rcversion}221230T013037Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.10.158-rt77
