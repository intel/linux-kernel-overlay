...
%define rpmversion  5.15.65
%if %{?isrc}
%define rcversion   rt49.
%endif
%define embargoname 0919.lts2021_rt
...
%define specrelease %{?rcversion}220919T045454Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.15.65-rt49
