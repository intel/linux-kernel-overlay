...
%define rpmversion  5.15.85
%if %{?isrc}
%define rcversion   rt55.
%endif
%define embargoname 0113.lts2021_rt
...
%define specrelease %{?rcversion}230113T035939Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.15.85-rt55
