...
%define rpmversion  5.15.96
%if %{?isrc}
%define rcversion   rt61.
%endif
%define embargoname 0422.lts2021_rt
...
%define specrelease %{?rcversion}230422T141430Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.15.96-rt61
