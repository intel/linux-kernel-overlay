...
%define rpmversion  5.10.115
%if %{?isrc}
%define rcversion   rt67.
%endif
%define embargoname 0523.lts2020_rt
...
%define specrelease %{?rcversion}220523T082401Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.10.115-rt67
