...
%define rpmversion  5.15.92
%if %{?isrc}
%define rcversion   rt57.
%endif
%define embargoname 0221.lts2021_rt
...
%define specrelease %{?rcversion}230221T145143Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.15.92-rt57
