...
%define rpmversion  5.15.32
%if %{?isrc}
%define rcversion   rt39.
%endif
%define embargoname 0418.lts2021_rt
...
%define specrelease %{?rcversion}220418T211422Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.15.32-rt39
