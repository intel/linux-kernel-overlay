...
%define rpmversion  5.10.140
%if %{?isrc}
%define rcversion   rt73.
%endif
%define embargoname 0927.lts2020_rt
...
%define specrelease %{?rcversion}220927T051119Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.10.140-rt73
