...
%define rpmversion  6.13.0
%if %{?isrc}
%define rcversion   rc3.
%endif
%define embargoname 1219.mainline_tracking
...
%define specrelease %{?rcversion}241219T072102Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v6.13-rc3
