...
%define rpmversion  5.15.31
%if %{?isrc}
%define rcversion   rt38.
%endif
%define embargoname 0412.lts2021_rt
...
%define specrelease %{?rcversion}220412T181419Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.15.31-rt38
