...
%define rpmversion  6.16.0
%if %{?isrc}
%define rcversion   rc3.
%endif
%define embargoname 0716.mainline_tracking
...
%define specrelease %{?rcversion}250716T065924Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v6.16-rc3
