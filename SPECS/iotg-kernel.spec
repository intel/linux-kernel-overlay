...
%define rpmversion  5.10.165
%if %{?isrc}
%define rcversion   rt81.
%endif
%define embargoname 0216.lts2020_rt
...
%define specrelease %{?rcversion}230216T141653Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.10.165-rt81
