...
%define rpmversion  5.15.71
%if %{?isrc}
%define rcversion   rt51.
%endif
%define embargoname 0104.lts2021_rt
...
%define specrelease %{?rcversion}230104T054143Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.15.71-rt51
