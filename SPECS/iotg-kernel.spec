...
%define rpmversion  5.15.21
%if %{?isrc}
%define rcversion   rt30.
%endif
%define embargoname 0224.lts2021_rt
...
%define specrelease %{?rcversion}220224T195512Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.15.21-rt30
