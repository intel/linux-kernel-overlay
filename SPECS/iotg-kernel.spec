...
%define rpmversion  5.10.109
%if %{?isrc}
%define rcversion   rt65.
%endif
%define embargoname 0422.lts2020_rt
...
%define specrelease %{?rcversion}220422T052359Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.10.109-rt65
