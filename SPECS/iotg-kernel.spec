...
%define rpmversion  5.15.107
%if %{?isrc}
%define rcversion   rt62.
%endif
%define embargoname 0503.lts2021_rt
...
%define specrelease %{?rcversion}230503T121257Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.15.107-rt62
