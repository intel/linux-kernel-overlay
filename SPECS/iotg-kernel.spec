...
%define rpmversion  5.15.43
%if %{?isrc}
%define rcversion   rt45.
%endif
%define embargoname 0601.lts2021_rt
...
%define specrelease %{?rcversion}220601T132130Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.15.43-rt45
