...
%define rpmversion  6.14.0
%if %{?isrc}
%define rcversion   rc3.
%endif
%define embargoname 0220.mainline_tracking
...
%define specrelease %{?rcversion}250220T031530Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v6.14-rc3
