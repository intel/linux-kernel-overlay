...
%define rpmversion  6.11.10
%if %{?isrc}
%define rcversion   .
%endif
%define embargoname 1201.mainline_tracking
...
%define specrelease %{?rcversion}241201T034125Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v6.11.10
