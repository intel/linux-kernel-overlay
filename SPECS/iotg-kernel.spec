...
# The rt version name will occupy the position of the rc version
# name in the kernel version
%global isrc 1

%define pkgrelease  36
%define rpmversion  5.10.168
%if %{?isrc}
%define rcversion   rt83.
%endif
%define embargoname 0306.lts2020_rt
...
%define specrelease %{?rcversion}230306T045633Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.10.168-rt83
