...
%define rpmversion  5.10.90
%if %{?isrc}
%define rcversion   rt60.
%endif
%define embargoname 0117.lts2020_rt
...
%define specrelease %{?rcversion}220117T232657Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.10.90-rt60
