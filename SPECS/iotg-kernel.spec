...
%define rpmversion  5.10.145
%if %{?isrc}
%define rcversion   rt74.
%endif
%define embargoname 0930.lts2020_rt
...
%define specrelease %{?rcversion}220930T073153Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.10.145-rt74
