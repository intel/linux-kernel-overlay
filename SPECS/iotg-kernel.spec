...
%define rpmversion  5.15.24
%if %{?isrc}
%define rcversion   rt31.
%endif
%define embargoname 0323.lts2021_rt
...
%define specrelease %{?rcversion}220323T080448Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.15.24-rt31
