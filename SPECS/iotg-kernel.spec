...
%define rpmversion  5.10.120
%if %{?isrc}
%define rcversion   rt70.
%endif
%define embargoname 0627.lts2020_rt
...
%define specrelease %{?rcversion}220627T101228Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.10.120-rt70
