...
%define rpmversion  5.15.94
%if %{?isrc}
%define rcversion   rt59.
%endif
%define embargoname 0330.lts2021_rt
...
%define specrelease %{?rcversion}230330T152241Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.15.94-rt59
