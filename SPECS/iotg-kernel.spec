...
%if %{?isrc}
%define rcversion   rt64.
%endif
%define embargoname 0413.lts2020_rt
...
%define specrelease %{?rcversion}220413T062501Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.10.106-rt64
