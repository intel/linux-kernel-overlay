...
%define rpmversion  5.10.153
%if %{?isrc}
%define rcversion   rt76.
%endif
%define embargoname 1208.lts2020_rt
...
%define specrelease %{?rcversion}221208T082634Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.10.153-rt76
