...
%define rpmversion  5.15.36
%if %{?isrc}
%define rcversion   rt41.
%endif
%define embargoname 0512.lts2021_rt
...
%define specrelease %{?rcversion}220512T225534Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.15.36-rt41
