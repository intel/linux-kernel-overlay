...
%define rpmversion  5.15.40
%if %{?isrc}
%define rcversion   rt43.
%endif
%define embargoname 0526.lts2021_rt
...
%define specrelease %{?rcversion}220526T200002Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.15.40-rt43
