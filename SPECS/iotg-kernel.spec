...
%define rpmversion  5.10.83
%if %{?isrc}
%define rcversion   rt58.
%endif
%define embargoname 1216.lts2020_rt
...
%define specrelease %{?rcversion}211216T011047Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.10.83-rt58
