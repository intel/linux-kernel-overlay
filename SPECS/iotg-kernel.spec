...
%define rpmversion  5.15.133
%if %{?isrc}
%define rcversion   rt69.
%endif
%define embargoname 1010.lts2021_rt
...
%define specrelease %{?rcversion}231010T064012Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.15.133-rt69
