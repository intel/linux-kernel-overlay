...
%define rpmversion  5.15.125
%if %{?isrc}
%define rcversion   rt66.
%endif
%define embargoname 0905.lts2021_rt
...
%define specrelease %{?rcversion}230905T192346Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.15.125-rt66
