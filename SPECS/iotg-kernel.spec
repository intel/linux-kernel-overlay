...
%define rpmversion  5.15.129
%if %{?isrc}
%define rcversion   rt67.
%endif
%define embargoname 0910.lts2021_rt
...
%define specrelease %{?rcversion}230910T213450Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.15.129-rt67
