...
%define rpmversion  5.10.78
%if %{?isrc}
%define rcversion   rt55.
%endif
%define embargoname 1129.lts2020_rt
...
%define specrelease %{?rcversion}211129T083101Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.10.78-rt55
