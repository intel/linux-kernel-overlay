...
%define rpmversion  6.12.0
%if %{?isrc}
%define rcversion   rc3.
%endif
%define embargoname 1022.mainline_tracking
...
%define specrelease %{?rcversion}241022T063118Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v6.12-rc3
