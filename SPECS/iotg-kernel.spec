...
%define rpmversion  5.15.86
%if %{?isrc}
%define rcversion   rt56.
%endif
%define embargoname 0131.lts2021_rt
...
%define specrelease %{?rcversion}230131T145545Z_%{pkgrelease}%{?dist}
...
%global kernel_src_tag v5.15.86-rt56
