...
> **Note**: `dpkg -i` does not resolve dependencies. Any package in this guide
> may require system or third-party packages that vary per distro and cannot all
> be listed here. Install the missing dependencies with the `apt` command based
