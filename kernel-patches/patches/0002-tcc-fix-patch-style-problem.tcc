From 373fec4111caec03d582b475349d4fbf8636d935 Mon Sep 17 00:00:00 2001
...
index 644dcfdc432e..e205bedbd1ec 100644
--- a/arch/x86/kernel/acpi/boot.c
+++ b/arch/x86/kernel/acpi/boot.c
@@ -1262,21 +1262,19 @@ static bool tcc_is_untracked_pat_range(u64 start, u64 end)
...
@@ -1295,7 +1293,6 @@ static int __init acpi_parse_ptct(struct acpi_table_header *table)
 	}
...
@@ -1315,7 +1312,6 @@ static int __init acpi_parse_ptct(struct acpi_table_header *table)
 		return -EINVAL;
...
@@ -1358,10 +1354,6 @@ static void __init acpi_process_ptct(void)
...
index 0eac5b59338f..5a15a10191ad 100644
--- a/include/acpi/actbl2.h
+++ b/include/acpi/actbl2.h
@@ -1560,13 +1560,11 @@ struct acpi_pptt_id {
  *        Version 1
  *
  ******************************************************************************/
-
...
@@ -1577,7 +1575,6 @@ enum acpi_ptct_entry {
...
@@ -1614,19 +1611,17 @@ struct ptct_psram_region {
  *
  ******************************************************************************/
 /* Values for Type field above */
-
