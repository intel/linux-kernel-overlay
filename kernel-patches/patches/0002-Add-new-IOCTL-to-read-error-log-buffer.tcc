From d90e604cd471869c6f1a7942ab3b1d3f351e48d8 Mon Sep 17 00:00:00 2001
From: Qiang Rao <qiang.rao@intel.com>
Date: Thu, 20 May 2021 17:57:47 +0800
Subject: [PATCH 2/4] Add new IOCTL to read error log buffer.
...
index 00fbffc70bec..edc46b2f98dc 100644
...
@@ -821,8 +1162,11 @@ static int tcc_buffer_open(struct inode *i, struct file *f)
 		return -EINVAL;
 	}
...
+	}
 	...
 	dprintk("%s\n", "open()");
@@ -935,6 +1279,8 @@ static long tcc_buffer_ioctl(struct file *filp, unsigned int cmd, unsigned long
...
@@ -1027,8 +1373,11 @@ static long tcc_buffer_ioctl(struct file *filp, unsigned int cmd, unsigned long
...
@@ -1111,6 +1460,30 @@ static long tcc_buffer_ioctl(struct file *filp, unsigned int cmd, unsigned long
 		if (ret != 0)
 			return -EFAULT;
...
+
 	...
 	default:
 		return -ENOIOCTLCMD;
@@ -1208,6 +1581,9 @@ static int __init tcc_buffer_init(void)
...
@@ -1233,6 +1609,8 @@ static void __exit tcc_buffer_exit(void)
...
index 969f9803e139..7fcce803c874 100644
