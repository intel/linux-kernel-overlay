From ce2777666ec7aa089888f2c139c9ad7c3f303efd Mon Sep 17 00:00:00 2001
From: Qiang Rao <qiang.rao@intel.com>
Date: Fri, 16 Oct 2020 15:17:44 +0800
Subject: [PATCH 02/23] tcc: this is kernel driver to interface to TCC PTCM
 pesudo SRAM
...
index b6a172d32a7d..342bb9127e1c 100644
--- a/drivers/Kconfig
+++ b/drivers/Kconfig
@@ -241,4 +241,5 @@ source "drivers/peci/Kconfig"
...
index 9a30842b22c5..302e0a5c3f9d 100644
--- a/drivers/Makefile
+++ b/drivers/Makefile
...
index 000000000000..372aadc602dc
--- /dev/null
+++ b/drivers/tcc/Kconfig
@@ -0,0 +1,9 @@
+# SPDX-License-Identifier: GPL-2.0
+
+menuconfig X86_TCC_PTCM
+    tristate "TCC_PTCM interface driver"
+    depends on X86 && ACPI
+    help
+      Select this option to access PTCM feature.
+
+      If unsure, say N.
diff --git a/drivers/tcc/Makefile b/drivers/tcc/Makefile
new file mode 100644
index 000000000000..e6524b2080d0
--- /dev/null
+++ b/drivers/tcc/Makefile
@@ -0,0 +1,6 @@
...
+#
+
+obj-$(CONFIG_X86_TCC_PTCM)	+= tcc_buffer.o
diff --git a/drivers/tcc/tcc_buffer.c b/drivers/tcc/tcc_buffer.c
new file mode 100644
index 000000000000..4d4e0557dddc
--- /dev/null
