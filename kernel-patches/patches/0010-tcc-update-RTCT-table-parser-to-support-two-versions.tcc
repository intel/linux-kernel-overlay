From 90cd812458cf0d8cdb31dab40cdcb2782b9f78b8 Mon Sep 17 00:00:00 2001
...
+	/* Parse for the third round to record address for each regions */
 	...
 	ptr = (u8 *)table;
 	ptr += PTCT_ACPI_HEADER_SIZE;
@@ -1283,11 +1309,20 @@ static int __init acpi_parse_ptct(struct acpi_table_header *table)
 		entry = (struct acpi_ptct_entry_header *)(ptr);
 		offset += entry->size;
